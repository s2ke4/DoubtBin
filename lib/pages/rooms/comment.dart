...
class _CommentState extends State<Comment> {
  ...
  Future<void> getInfo()async{
     setState((){
      isLiked = (widget.comment.likedUser[currentUser.uid]==true)?true:false;
      isDisLiked = (widget.comment.disLikedUser[currentUser.uid]==true)?true:false;
     });
  ...
  void handleLike(){
      setState((){
        widget.comment.numberOfDislikes = isDisLiked?widget.comment.numberOfDislikes-1:widget.comment.numberOfDislikes;
        widget.comment.disLikedUser[currentUser.uid] = false;
        widget.comment.likedUser[currentUser.uid] = !isLiked;
        widget.comment.numberOfLikes = widget.comment.likedUser[currentUser.uid]?widget.comment.numberOfLikes+1:widget.comment.numberOfLikes-1;
      });
      BinDatabase().likeComment(widget.roomId,widget.postId,widget.commentId,widget.comment.likedUser[currentUser.uid],widget.comment.numberOfLikes,widget.comment.disLikedUser[currentUser.uid],widget.comment.numberOfDislikes);
  }

  void handleDislike(){
      setState((){
        widget.comment.numberOfLikes = isLiked?widget.comment.numberOfLikes-1:widget.comment.numberOfLikes;
        widget.comment.likedUser[currentUser.uid] = false;
        widget.comment.disLikedUser[currentUser.uid] = !isDisLiked;
        widget.comment.numberOfDislikes = widget.comment.disLikedUser[currentUser.uid]?widget.comment.numberOfDislikes+1:widget.comment.numberOfDislikes-1;
      });
      BinDatabase().disLikeComment(widget.roomId,widget.postId,widget.commentId,widget.comment.disLikedUser[currentUser.uid],widget.comment.numberOfDislikes,widget.comment.likedUser[currentUser.uid], widget.comment.numberOfLikes);
  }
                    ...
                    Row(
                      children: [
                        IconButton(
                          ...
                          icon:isLiked?Icon(Icons.thumb_up,color: Colors.blue[500],size:20 ):Icon(Icons.thumb_up,size:20 ),
                        ...
                        IconButton(
                          padding: EdgeInsets.all(0),
                          icon:isDisLiked?Icon(Icons.thumb_down,color: Colors.red[500], size:20):Icon(Icons.thumb_down,size:20 ),
