        ...
        body: Container(
          ...
          child: Column(
              children: [
                SizedBox(height: 50),
                TextFormField(
                  onChanged: (val){setState(()=>correctUserName=val.length>2?true:false);},
                  controller: userNameController,
                  decoration: InputDecoration(
                      hintText: "Enter new username",
                      labelText:"User Name",
                      errorText: correctUserName?null:"user name must be atleast 3 character long",
                ...
                GestureDetector(
                  child: Container(
                    ...
                    child: Text("Enter",style: TextStyle(color:Colors.white,fontSize:18),),
                  ),
