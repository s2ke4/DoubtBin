...
class _AboutUsState extends State<AboutUs> {
  ...
  List<Devs> devs = [
    ...
    Devs(name: "Darshan Devendra Hande", email: "darshanhande11@gmail.com", buff: "Flutter | Javascript | Python | Firebase | Dart | Java | C++ | HTML | CSS | C | Cloud | React ", description: "A paragraph is a series of related sentences developing a central idea, called the topic. Try to think about paragraphs in terms of thematic unity: a paragraph is a sentencgraphs add one idea at a time to your broader argument.", imgURL: "3.jpg", github: "https://github.com/darshanhande11", linkedin: "https://www.linkedin.com/in/darshan-hande-6a7479128/"),
